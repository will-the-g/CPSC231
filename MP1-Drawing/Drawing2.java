...
public class Drawing2{
    ...
    public char[][] addCharacter(char[][] canvas, char character, int[] coordinates){
    ...
    public boolean rangeCheck(int[] coordinates){
    ...
    public static void main(String[] args){
        ...
        while (!(option.equals("exit"))){
            if (option.equals("add")){
                ...
                canvas = addCharacter(canvas, character, coordinates);
                printCanvas(canvas);
                System.out.println("Would you like to 'add' a character, 'erase' a character, or 'clear' a new canvas? (Enter 'exit' to leave)");
